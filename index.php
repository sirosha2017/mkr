...
<nav class="sticky top-0 h-20 bg-[#243c5a] p-5 sm:px-24 xl:px-64">
  <div class="mx-auto flex justify-between items-center">
    <a href="#"
       class="uppercase text-white text-xl xl:text-3xl font-bold whitespace-no-wrap font-Montserrat leading-normal tracking-tighter"> <?php
...
if ($result->num_rows > 0) {
    ...
    if ($showMore >= $total_houses) {
        ...
        echo "<div class=\"flex justify-end mt-4 mr-6\">";
        echo "<a href=\"?houses=" . ($showMore + 6) . "\" class=\"bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded\">Show More</a>";
...
<a class="weatherwidget-io" href="https://forecast7.com/uk/50d6226d25/rivne/" data-label_1="RIVNE" data-icons="Climacons Animated" data-theme="dark" data-textcolor="#29e70b" data-highcolor="#0923f5" data-lowcolor="#f90202" >RIVNE</a>
<script>
